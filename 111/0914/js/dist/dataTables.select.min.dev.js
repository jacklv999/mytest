...
(function (h) {
  ...
  }) : "object" === (typeof exports === "undefined" ? "undefined" : _typeof(exports)) ? module.exports = function (q, t) {
    q || (q = window);
  ...
  function F(a) {
    ...
    b.on("mousedown.dtSelect", d, function (g) {
      ...
      if (h(g.target).closest("div." + l)[0] == a.table().container() && (l = a.cell(h(g.target).closest("td, th")), l.any())) {
        ...
        r(a, p, [f, l, g]);
        p.isDefaultPrevented() || (p = l.index(), "row" === f ? (f = p.row, B(g, a, k, "row", f)) : "column" === f ? (f = l.index().column, B(g, a, k, "column", f)) : "cell" === f && (f = l.index(), B(g, a, k, "cell", f)), k._select_lastCell = p);
      }
    });
  ...
  v("select.items()", function (a) {
    return a === n ? this.context[0]._select.items : this.iterator("table", function (b) {
      b._select.items = a;
